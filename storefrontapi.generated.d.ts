...
> & {
  ...
  sellingPlanAllocation?: StorefrontAPI.Maybe<{
    sellingPlan: Pick<StorefrontAPI.SellingPlan, 'id' | 'name' | 'description'>;
  }>;
  merchandise: Pick<
    StorefrontAPI.ProductVariant,
    'id' | 'availableForSale' | 'requiresShipping' | 'title'
...
export type SellingPlanFragmentFragment = Pick<
  StorefrontAPI.SellingPlan,
  'id' | 'name' | 'description'
> & {
  options: Array<Pick<StorefrontAPI.SellingPlanOption, 'name' | 'value'>>;
  ...
  sellingPlanGroups: {
    nodes: Array<
      Pick<StorefrontAPI.SellingPlanGroup, 'name'> & {
        ...
        sellingPlans: {
          nodes: Array<
            Pick<StorefrontAPI.SellingPlan, 'id' | 'name' | 'description'> & {
              options: Array<
                Pick<StorefrontAPI.SellingPlanOption, 'name' | 'value'>
              >;
              priceAdjustments: Array<
...
export type ProductBasicInfoQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;
...
export type ProductPriceForOverviewQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type ProductPriceForOverviewQuery = {
  product?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query ProductBasicInfo($handle: String!) {\n    product(handle: $handle) {\n      id\n      title\n      handle\n      description\n      variants(first: 1) {\n        nodes {\n          id\n          price {\n            amount\n            currencyCode\n          }\n          compareAtPrice {\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n  }\n': {
    return: ProductBasicInfoQuery;
    variables: ProductBasicInfoQueryVariables;
  };
  ...
  '#graphql\n  query ProductPriceForOverview($handle: String!) {\n    product(handle: $handle) {\n      id\n      title\n      handle\n      variants(first: 1) {\n        nodes {\n          id\n          price {\n            amount\n            currencyCode\n          }\n          compareAtPrice {\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n  }\n': {
    return: ProductPriceForOverviewQuery;
    variables: ProductPriceForOverviewQueryVariables;
  };
}
