...
const ScenarioCard = ({
    ...
    return (
        <div
            className={`relative overflow-hidden max-w-md mx-auto transition-all duration-300 transform ${
                isHovered ? "scale-102" : ""
            }`}
            style={{
                background: "black",
        ...
        >
            ...
            {/* Card Content */}
            <div className="relative h-full flex flex-col z-10 p-6 text-white">
                {/* Top Badge */}
                ...
                {/* Description */}
                <p className="text-white leading-tight text-sm text-center">
                    {description}
                </p>

                {/* Bottom Section (Stats + Button) - Always at bottom */}
                <div className="mt-auto">
                    {/* Stats */}
                    <div className="flex items-center text-sm text-white mt-4 mb-4">
                    ...
                    <button
                        onClick={onClick}
                        className="shadow-lg border border-[#ffffff] w-full flex items-center justify-between px-4 py-2 text-sm font-bold transition-all duration-300 bg-[#ff0000] hover:bg-[#ff8181] text-white"
                    >
                        <span>{ctaText}</span>
                        <ChevronRight
                            size={16}
